   ...
   const quillRef = useRef(null)
    ...
    const onSubmitHandler = async (e) => {
        try{
            ...
            const formData = new FormData(); // creted function
            formData.append('nilesh' , JSON.stringify(blog)) // appending in forData nilesh is key takung data see backend bro
            formData.append('image' , image)// appending in forData
    ...
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
        <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
           <p>Upload thumbnail</p>
            ...
            <div className='max-w-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
